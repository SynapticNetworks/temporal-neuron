...
func (cm *ChemicalModulator) initializeBiologicalKinetics() {
	...
	// === CALCIUM - Essential Plasticity Signaling ===
	cm.ligandKinetics[LigandCalcium] = LigandKinetics{
		DiffusionRate:   0.65, // Fast diffusion in cytoplasm
		DecayRate:       0.80, // Rapid buffering by calcium-binding proteins
		ClearanceRate:   0.70, // Active pumping and sequestration
		MaxRange:        8.0,  // Spreads in dendritic compartments
		BindingAffinity: 0.95, // Very high affinity for binding proteins
		Cooperativity:   2.0,  // Cooperative binding kinetics
	}
